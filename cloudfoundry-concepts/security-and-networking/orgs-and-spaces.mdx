...
authorization features in <AppRuntimeFirst/>.

An installation of <AppRuntimeAbbr/> is referred to as a _foundation_.
Each foundation has _orgs_ and _spaces_. For more information, see [Orgs, Spaces, Roles, and Permissions](./roles.html).

The <AppRuntimeAbbr/> roles described in _Orgs, Spaces, Roles, and Permissions_ use the principle of least privilege. Each role exists for a purpose and features in <AppRuntimeAbbr/> enable these purposes.

Consider these roles when planning your foundations, orgs, and spaces. This allows for full use of the features and assumptions of <AppRuntimeAbbr/>.


## <a id="conceptual"></a> How <AppRuntimeAbbr/> layers relate to your company

The following sections describe what <AppRuntimeAbbr/> layers are and how they relate to your company structure.

### <a id="layers"></a> Overview of <AppRuntimeAbbr/> layers

For an overview of each of the structural <AppRuntimeAbbr/> layers, see the following table:

<table>
<thead>
	<tr>
		<th><AppRuntimeAbbr/> Layer</th>
...
![Foundations roughly map to a company and to an environment](../../static/images/mapping_foundations.png)
...
structure to a <AppRuntimeAbbr/> org, see the following diagram:

![Orgs can encompass Business Units, environments, teams, or products](../../static/images/mapping_organizations.png)


### <a id="mappingspaces"></a> Spaces


Spaces can encompass teams, products, and specific deployables. To understand how you can map your company structure to a <AppRuntimeAbbr/> space, see the following diagram:

![Spaces can encompass Teams, Products and specific deployables](../../static/images/mapping_spaces.png)
...
To effectively plan your environments, you must decide at what <AppRuntimeAbbr/> layer they belong.
...
For examples of environments and how they map to <AppRuntimeAbbr/> layers, see the following table:
...
### <a id="considerations"></a> Questions to consider about each <AppRuntimeAbbr/> layer

For guiding questions to help you make decisions about planning your <AppRuntimeAbbr/> structure, see the following table:
...
_Subsets_ are the company divisions you decide to map to <AppRuntimeAbbr/>. When creating your subsets, consider that the lower the <AppRuntimeAbbr/> layer, the more specific you want to map your subsets. Conversely, the higher the <AppRuntimeAbbr/> layer, the broader you want to make your subsets.

For more information about mapping larger subsets for each <AppRuntimeAbbr/> layer, see the following table:
...
<table>
	...
	<tr>
		...
		<td>
			<ul>
				<li>More likelihood of accidental changes to someone else’s app or service</li>
...
For more information about mapping smaller subsets for each <AppRuntimeAbbr/> layer, see the following table:
